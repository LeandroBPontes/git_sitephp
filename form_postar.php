...
<body>
	...
	<form action= "postar.php" method="POST" enctype="multipart/form-data">
		...
		<textarea name="conteudo" class="campos_cad" placeholder="digite o conteudo..." style="height: 300px" maxlength="500"></textarea>
	...
	<a href="form_scripts.php" class="form_link"> Ir para scripts &rarr;</a>
